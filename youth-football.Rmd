...
census_data_oh_2021 <- bind_rows(census_data_oh_2021, census_data_oh_subdivisions_2021) %>%
  filter(!(city == "Colerain" & geoid != "3906116616")) %>% #Keeping only Colerain in Hamilton County
  filter(!(city == "Concord" & geoid != "3908518196")) %>% #Keeping only Concord in Lake County
  filter(!(city == "Liberty" & geoid != "3901743050")) %>% #Keeping only Liberty in Butler County
  mutate(city = case_when(
