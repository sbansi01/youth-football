...
football_rosters <- football_rosters %>%
  ...
  separate(hometown_cleaning, into = c("hometown_city_clean", "hometown_state", "hometown_country"), sep = ", ")
...
hometowns_open_refine_modified <- hometowns_open_refine %>%
  select(hometown_city_clean, hometown_city_clean, hometown_state_clean)

football_rosters_usa <- football_rosters_usa %>%
  left_join(hometowns_open_refine_modified, by = c("hometown_city_clean", "hometown_state_clean"))
