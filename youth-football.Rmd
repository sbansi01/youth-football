...
hometowns_complete <- bind_rows(hometowns_al_complete, hometowns_fl_complete, hometowns_ga_complete, hometowns_la_complete, hometowns_ms_complete, hometowns_tx_complete) %>%
  arrange(desc(players_per_thousand))
