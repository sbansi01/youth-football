...
hometowns_al_complete <- hometowns_al_complete %>%
  mutate(black_pop_vs_state = if_else(
    pct_black > pct_black_al, "above", "below or equal"))
...
# Figuring out Black population in the state
black_pop_az_2021 <- get_acs(geography = "state",
                           variables = c("B01003_001", "B02001_003"),
                           year = 2021,
                           state = "AZ",
                           output = "wide") %>%
...
# Storing the Black population as a value
pct_black_az <- black_pop_az_2021$pct_black

# Add to hometowns dataframe
hometowns_az_complete <- hometowns_az_complete %>%
  mutate(black_pop_vs_state = if_else(
    pct_black > pct_black_az, "above", "below or equal"))

# Summary
race_analysis_az <- hometowns_az_complete %>%
  group_by(black_pop_vs_state) %>%
  summarize(
    total_towns = n(),
    sum_total_pop = sum(total_pop),
...
# Figuring out Black population in the state
black_pop_ar_2021 <- get_acs(geography = "state",
                           variables = c("B01003_001", "B02001_003"),
                           year = 2021,
                           state = "AR",
                           output = "wide") %>%
...
# Storing the Black population as a value
pct_black_ar <- black_pop_ar_2021$pct_black

# Add to hometowns dataframe
hometowns_ar_complete <- hometowns_ar_complete %>%
  mutate(black_pop_vs_state = if_else(
    pct_black > pct_black_ar, "above", "below or equal"))

# Summary
race_analysis_ar <- hometowns_ar_complete %>%
  group_by(black_pop_vs_state) %>%
  summarize(
    total_towns = n(),
    sum_total_pop = sum(total_pop),
...
# Figuring out Black population in the state
black_pop_la_2021 <- get_acs(geography = "state",
                           variables = c("B01003_001", "B02001_003"),
                           year = 2021,
                           state = "LA",
                           output = "wide") %>%
...
# Storing the Black population as a value
pct_black_la <- black_pop_la_2021$pct_black

# Add to hometowns dataframe
hometowns_la_complete <- hometowns_la_complete %>%
  mutate(black_pop_vs_state = if_else(
    pct_black > pct_black_la, "above", "below or equal"))

# Summary
race_analysis_la <- hometowns_la_complete %>%
  group_by(black_pop_vs_state) %>%
  summarize(
    total_towns = n(),
    sum_total_pop = sum(total_pop),
...
# Figuring out Black population in the state
black_pop_ms_2021 <- get_acs(geography = "state",
                           variables = c("B01003_001", "B02001_003"),
                           year = 2021,
                           state = "MS",
                           output = "wide") %>%
...
# Storing the Black population as a value
pct_black_ms <- black_pop_ms_2021$pct_black

# Add to hometowns dataframe
hometowns_ms_complete <- hometowns_ms_complete %>%
  mutate(black_pop_vs_state = if_else(
    pct_black > pct_black_ms, "above", "below or equal"))

# Summary
race_analysis_ms <- hometowns_ms_complete %>%
  group_by(black_pop_vs_state) %>%
  summarize(
    total_towns = n(),
    sum_total_pop = sum(total_pop),
...
# TRYING TO FIGURE OUT NEXT STEPS FOR RACIAL ANALYSIS

# STATE-BY-STATE BLACK POP - trying to figure out what states would be worth doing more analysis on race
