...
hometowns_open_refine <- read_csv("hometowns_open_refine.csv") %>%
  mutate(hometown_city_clean = case_when(
    hometown_city_clean == "John's Creek" ~ "Johns Creek",
    TRUE ~ hometown_city_clean))
...
city_pops_se_2021 <- bind_rows(city_pops_se_2021, ellenwood_pop_2021, highland_pop_2021, nesbit_pop_2021, rabun_pop_2021, rex_pop_2021, sublinga_pop_2021)
